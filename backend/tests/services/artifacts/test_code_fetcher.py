"""Tests for opening and fetching code repositories from remote providers."""
...
from tests.utils import build_tgz, make_response


def test_open_codebase_unsupported_host() -> None:
    """Test that an unsupported host raises an error."""
...
class TestGitHubCodeFetcher:
    ...
    @patch("app.services.artifacts.code_fetcher.requests.get")
    ...
    @patch("app.services.artifacts.code_fetcher.requests.get")
    def test_github_http_error_maps_to_runtime_error(self, mock_get: MagicMock) -> None:
        """Test HTTP errors from the GitHub API raise RuntimeError."""
...
class TestGitLabCodeFetcher:
    ...
    @patch("app.services.artifacts.code_fetcher.requests.get")
    def test_gitlab_http_error_maps_to_runtime_error(self, mock_get: MagicMock) -> None:
        """Test HTTP errors from the GitLab API raise RuntimeError."""
...
@patch("app.services.artifacts.code_fetcher.requests.get")
def test_tarball_network_error_maps_to_runtime_error(mock_get: MagicMock) -> None:
